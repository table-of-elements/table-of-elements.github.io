...
<div class="landing">
  <div class="toe-hero-center">
    <div class="toe-eyebrow">Das Methodensystem für Projekte</div>
    <h1>Orientierung im<br>Methodendschungel</h1>
    <p class="toe-lead">Das Periodensystem der Projektmanagement-Methoden bietet 132 bewährte Werkzeuge, Modelle und Frameworks – geordnet, bewertet und sofort auffindbar.</p>
    <div class="toe-btnrow">
      <a class="btn btn-primary" href="{{ '/de/methoden/' | relative_url }}">Zur Übersicht</a>
      <a class="btn btn-outline-primary" href="{{ '/de/buch-app/' | relative_url }}">Buch &amp; App</a>
    </div>
    <div class="toe-pstrip">
      ...
      {% for c in toe_home_codes %}
        ...
        {% if toe_he %}
          {% assign toe_he_img = "assets/img/elements/de/" | append: toe_he.code | append: ".card.png" %}
          <a class="toe-phototile" href="{{ '/de/elements/' | append: toe_he.code | append: '/' | relative_url }}" aria-label="{{ toe_he.title_de }}">
            {% include figure.liquid loading="eager" path=toe_he_img class="img-fluid" width="220" height="220" alt=toe_he.title_de %}
          </a>
        {% endif %}
      {% endfor %}
    </div>
  ...
  <h2 class="mt-5">So funktioniert's</h2>
  <div class="row row-cols-1 row-cols-md-3 mt-3">
    <div class="col mb-4">
      <div class="card h-100 hoverable">
        <div class="card-body">
          <div class="toe-step-num">1</div>
          <h3 class="card-title">Situation einordnen</h3>
          <p class="card-text">Egal ob Planung, Steuerung, Risiko oder Team &amp; Umfeld – finde einen schnellen Einstieg in die 132 Elemente der Table.</p>
        </div>
      </div>
    </div>
    <div class="col mb-4">
      <div class="card h-100 hoverable">
        <div class="card-body">
          ...
          <h3 class="card-title">Filtern oder suchen</h3>
          <p class="card-text">Filter nach Kategorie oder suche direkt.</p>
        </div>
      </div>
    </div>
    <div class="col mb-4">
      <div class="card h-100 hoverable">
        <div class="card-body">
          ...
          <h3 class="card-title">Anwenden</h3>
          <p class="card-text">Vollständige Schritt-für-Schritt-Anleitung in Buch &amp; App.</p>
        </div>
      </div>
    </div>
  </div>
  <div class="text-center mt-3">
    <a class="btn btn-primary" href="{{ '/de/methoden/' | relative_url }}">Alle 132 Methoden ansehen</a>
  </div>

  <h2 class="mt-5">Kostenlos: das Methoden-Poster</h2>
  <div class="card hoverable mt-3">
    <div class="card-body d-flex flex-wrap align-items-center toe-gap-24">
      {% include figure.liquid loading="eager" path="assets/img/toe/poster-preview.png" class="img-fluid toe-poster-preview" width="680" height="481" alt="Vorschau: Methoden-Poster" %}
      <div class="toe-flex-1">
        <h3 class="mt-0">Alle 132 Methoden als Poster</h3>
        <p>Früher im Shop – jetzt kostenlos zum Download, auf Deutsch &amp; Englisch.</p>
        <a class="btn btn-primary" href="{{ '/de/downloads/' | relative_url }}">Zu den Downloads</a>
      </div>
    </div>
  </div>

  <h2 class="mt-5" id="fundament">Das Fundament: Buch &amp; App</h2>
  <div class="row row-cols-1 row-cols-md-2 mt-3">
    <div class="col mb-4">
      <div class="card h-100 hoverable text-center">
        <div class="card-body d-flex flex-column justify-content-center h-100">
          {% include figure.liquid loading="eager" path="assets/img/toe/buchcover.jpg" class="img-fluid rounded toe-book-cover" width="180" height="255" alt="Buchcover: Das Methodensystem für Projekte" %}
          <h3 class="mt-3">Das Methodensystem für Projekte</h3>
          <p class="card-text">Bernhard Schloß &amp; Christian Botta · Hanser Verlag</p>
          <a class="btn btn-outline-primary" href="https://www.hanser-fachbuch.de/Das-Methodensystem-fuer-Projekte/978-3-446-48367-5" target="_blank" rel="noopener">Zum Buch</a>
        </div>
      </div>
    </div>
    <div class="col mb-4">
      <div class="card h-100 hoverable text-center">
        <div class="card-body d-flex flex-column justify-content-center h-100">
          ...
          {% include figure.liquid loading="eager" path="assets/img/toe/app-screenshots.png" class="img-fluid rounded mt-2" width="1200" height="800" alt="PM Elements App – Screenshots iPhone &amp; iPad" %}
          <p class="card-text mt-2">Alle Methoden interaktiv, filterbar, unterwegs.</p>
          <a class="btn btn-outline-primary" href="https://apps.apple.com/at/app/pm-elements/id6738084498" target="_blank" rel="noopener">Im App Store</a>
        </div>
      </div>
    </div>
  </div>

  <h2 class="mt-5">Folge uns</h2>
  <div class="row row-cols-1 row-cols-md-2 mt-3">
    <div class="col mb-4">
      <a class="card h-100 hoverable toe-follow-card" href="https://www.linkedin.com/company/88909321/" target="_blank" rel="noopener">
        <div class="card-body d-flex align-items-center toe-gap-14">
          ...
          <div>
            ...
            <p class="card-text">„Element der Woche" &amp; Neuigkeiten – 1.146+ Follower:innen.</p>
          </div>
        </div>
      </a>
    </div>
      ...
      <a class="card h-100 hoverable toe-follow-card" href="https://www.youtube.com/@Table-of-Elements_io" target="_blank" rel="noopener">
        <div class="card-body d-flex align-items-center toe-gap-14">
          ...
          <div>
            ...
            <p class="card-text">Methoden im Video erklärt. Kurze, praxisnahe Clips zu einzelnen Elementen des Methodensystems.</p>
          </div>
        </div>
      </a>
    </div>
